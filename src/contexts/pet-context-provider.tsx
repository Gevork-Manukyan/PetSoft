...
export type PetContextType = {
    ...
    handleSelectPetId: (petId: string | null) => void;
...
export default function PetContextProvider({ children, pets: petsState }: { children: React.ReactNode, pets: Pet[] }) {
    const [selectedPetId, setSelectedPetId] = useState<string | null>(null);
    const selectedPet = petsState.find((pet) => pet.id === selectedPetId) || null;
    const guests = petsState.length;

    const handleSelectPetId = (petId: string | null) => {
