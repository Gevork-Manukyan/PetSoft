...
export default function PetForm({ actionType, onFormSubmit }: PetFormProps) {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const newPet = {
            ...
            imageURL: formData.get(PetFormFields.URL) as string || "https://bytegrad.com/course-assets/react-nextjs/pet-placeholder.png",
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
            <div className="space-y-3">
                <FormDiv>
                    ...
                    <Input id={PetFormFields.NAME} name={PetFormFields.NAME} type="text" required />
                </FormDiv>
                <FormDiv>
                    <Label htmlFor={PetFormFields.OWNER}>Owner</Label>
                    <Input id={PetFormFields.OWNER} name={PetFormFields.OWNER} type="text" required />
                </FormDiv>
                <FormDiv>
                    <Label htmlFor={PetFormFields.URL}>Image URL</Label>
                    <Input id={PetFormFields.URL} name={PetFormFields.URL} type="text" />
                </FormDiv>
                <FormDiv>
                    <Label htmlFor={PetFormFields.AGE}>Age</Label>
                    <Input id={PetFormFields.AGE} name={PetFormFields.AGE} type="number" required />
                </FormDiv>
                <FormDiv>
                    <Label htmlFor={PetFormFields.NOTES}>Notes</Label>
                    <Textarea id={PetFormFields.NOTES} name={PetFormFields.NOTES} rows={3} required />
                </FormDiv>
            </div>
